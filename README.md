...
Respecto a la escalabilidad, esta opción permite automatizar la escalabilidad de los recursos de los contenedores, a diferencia de Docker-compose, en el cual la escalabilidad se realiza de forma manual para cada contenedor individualmente.
